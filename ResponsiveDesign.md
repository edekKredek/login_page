# Responsive Design & Validation Style Guide

This page contains the responsive design, validation rules, and accessibility guidance extracted from `docs/STYLE_GUIDE.md` for publishing to the project Wiki.
...
- When updating validation rules in `src/components/LoginForm.jsx`, update this page accordingly.
...
Reference: `src/components/LoginForm.jsx` and `docs/STYLE_GUIDE.md`.
